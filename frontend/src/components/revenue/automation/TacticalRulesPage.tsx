 ...
 *
 * Layout : container max-w-[1600px], header Flowtym standard, tabs sous le
 * titre, contenu de l'onglet en pleine largeur. Pas de sidebar/panel : la
 * lecture reste simple et directe, comme demandé.
 */
