  ...
  finance: [
    {
      ...
      items: [
        ...
        { id: 'fin_house_accounts',  label: 'Comptes internes',       icon: Building2 },
        { id: 'fin_deposits',        label: 'Garanties & Acomptes',   icon: ShieldCheck },
        { id: 'fin_timeline',        label: 'Timeline financière',    icon: Clock },
        { id: 'fin_group_billing',   label: 'Facturation groupe',     icon: Users },
      ],
    },
  ],
