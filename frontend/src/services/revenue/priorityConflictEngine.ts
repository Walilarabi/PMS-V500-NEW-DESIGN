...
export const priorityConflictEngine = {
  ...
  simulate(ruleId: string, toPosition: number): PrioritySimulation {
    ...
    return {
      ...
      fromPosition: from,
      toPosition,
      estimatedRevpar: Math.round(delta * 100),
