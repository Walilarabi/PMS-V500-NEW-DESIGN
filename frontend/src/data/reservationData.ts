// Liste complète des pays du monde avec drapeaux emoji
...
export const OTA_SOURCES = [
  ...
  { id: 'EXPEDIA',      label: 'Expedia',            color: '#FFC72C' },
  { id: 'AIRBNB',       label: 'Airbnb',             color: '#FF5A5F' },
  { id: 'AGODA',        label: 'Agoda',              color: '#E81932' },
  { id: 'CTRIP',        label: 'Ctrip / Trip.com',   color: '#1A8AD4' },
  { id: 'LASTMINUTE',   label: 'LastMinute',         color: '#E31E24' },
  { id: 'HOTELBEDS',    label: 'Hotelbeds',          color: '#FF6B35' },
  { id: 'HRS',          label: 'HRS',                color: '#0066CC' },
  { id: 'HOTELS_COM',   label: 'Hotels.com',         color: '#D10000' },
  { id: 'TRIVAGO',      label: 'Trivago',            color: '#E74C3C' },
  { id: 'GOOGLE',       label: 'Google Hotels',      color: '#4285F4' },
  { id: 'KAYAK',        label: 'Kayak',              color: '#FF690F' },
  { id: 'HOSTELWORLD',  label: 'Hostelworld',        color: '#F96815' },
  { id: 'MRJET',        label: 'Mr Jet',             color: '#1EAEDB' },
  { id: 'VOYAGE_PRIVE', label: 'Voyage Privé',       color: '#6C1A6E' },
  { id: 'THOMAS_COOK',  label: 'Thomas Cook',        color: '#F7941D' },
  { id: 'TRAVELODGE',   label: 'Travelodge',         color: '#E20A0A' },
  { id: 'OPODO',        label: 'Opodo',              color: '#E31E24' },
  { id: 'TRABBER',      label: 'Trabber',            color: '#E31E24' },
  { id: 'MISTERFLY',    label: 'Misterfly',          color: '#0062FF' },
  { id: 'EVANEOS',      label: 'Evaneos',            color: '#FF6B35' },
  { id: 'KUONI',        label: 'Kuoni',              color: '#009FDA' },
  { id: 'TRAVELCLICK',  label: 'TravelClick',        color: '#004B87' },
  { id: 'SYNXIS',       label: 'SynXis',             color: '#E31E24' },
  { id: 'GDS_AMADEUS',  label: 'GDS Amadeus',        color: '#0052CC' },
  { id: 'GDS_SABRE',    label: 'GDS Sabre',          color: '#D40000' },
  { id: 'GDS_GALILEO',  label: 'GDS Galileo/Travelport', color: '#00338D' },
  { id: 'TO_AUTRE',     label: 'Tour Opérateur autre', color: '#7C3AED' },
  { id: 'CORPORATE',    label: 'Compte Corporate',   color: '#374151' },
  { id: 'GROUPE',       label: 'Réservation Groupe', color: '#059669' },
  { id: 'WALK_IN',      label: 'Walk-in',            color: '#6B7280' },
];
