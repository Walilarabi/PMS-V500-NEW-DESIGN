-- ============================================================================
-- FLOWTYM PMS — Migration 0141 : FEC view — extend payment_method aliases
-- ----------------------------------------------------------------------------
-- Le mapping initial de 0140 manquait les libellés français complets ("Carte
-- bancaire", "Espèces"...). On enrichit la liste pour couvrir tous les libellés
-- réellement présents dans la table payments.
-- ============================================================================
